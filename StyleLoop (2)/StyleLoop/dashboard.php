    ...
    <main class="main-panel">
        <div class="panel-card">
            ...
            <div class="quick-actions">
                ...
                <a class="quick-box" href="purchaseHistory.php"><span class="quick-icon">📊</span>Purchase History</a>
            </div>
        </div>
        <div class="panel-card">
        ...
        <div class="panel-card">
            ...
            while ($item = $items->fetch_assoc()) {
                ...
                echo "<p><strong>Shop Status:</strong> " . htmlspecialchars($item['ApprovalStatus']) . "</p>";
                echo "<p><strong>Availability:</strong> " . htmlspecialchars($item['Availability']) . "</p></div></div>";
            }
            ?>
            </div>
        </div>
